...
void InitializeSdkObjects(FbxManager*& pManager, FbxScene*& pScene)
{
	...
	else
    {
        ...
        FBXSDK_printf("Autodesk FBX SDK version %s (FBX file format %d.%d.%d)\n", pManager->GetVersion(), lSDKMajor, lSDKMinor, lSDKRevision);
    }
...
void DestroySdkObjects(FbxManager* pManager, bool pExitStatus)
{
	...
	if( pExitStatus ) FBXSDK_printf("Done.\n");
}
...
//        }
//    }
//    lExporter->SetFileExportVersion("FBX201800");

    FBXSDK_printf("Saved file '%s'!\n", pFilename);
